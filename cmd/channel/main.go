// Command channel 是 channel 服务的装配根：读配置、构造 Logger 与根 ctx，
...
import (
	...
	"github.com/yanking/go-skeleton/cmd/channel/initial"
...
func main() {
	configFile := flag.String("config", "./configs/channel.yaml", "path to config file")
	flag.Parse()
