// Command payment 是 payment 服务的装配根：读配置、构造 Logger 与根 ctx，
...
import (
	...
	"github.com/yanking/go-skeleton/cmd/payment/initial"
...
func main() {
	configFile := flag.String("config", "./configs/payment.yaml", "path to config file")
	flag.Parse()
