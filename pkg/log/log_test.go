...
func TestNewWritesJSONWithService(t *testing.T) {
	...
	logger := log.New(log.Config{Service: "user", Writer: &buf})
...
func TestNewTextFormat(t *testing.T) {
	var buf bytes.Buffer
	logger := log.New(log.Config{Service: "user", Format: log.FormatText, Writer: &buf})
...
func TestNewLevel(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			var buf bytes.Buffer
			logger := log.New(log.Config{Service: "user", Level: tt.level, Writer: &buf})
...
func TestNewAddSource(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			var buf bytes.Buffer
			logger := log.New(log.Config{Service: "user", AddSource: tt.addSource, Writer: &buf})
